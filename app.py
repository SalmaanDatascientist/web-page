...
# Added "🤖 Student Support Bots" to the menu list
page = st.sidebar.radio("Go to", ["Home & Services", "🐍 Python Bootcamp", "🤖 Student Support Bots", "About Instructor", "Contact"])
...
if page == "Home & Services":
    ...
    c1, c2 = st.columns(2)
    with c1:
        st.info("**NO EXTRA CHARGES FOR IGCSE,ICSE,ISC etc.,**")
...
# -----------------------------------------------------------------------------
# PAGE: STUDENT SUPPORT BOTS (NEW)
# -----------------------------------------------------------------------------
elif page == "🤖 Student Support Bots":
    st.header("🤖 Student Support Bots")
    st.write("Access our exclusive AI-powered tools designed to help you solve complex problems instantly.")
...
# -----------------------------------------------------------------------------
    ...
    with col_text:
        ...
        - **Teaching Experience:** Founder of The Molecular Man Expert Tuition Solutions.
