...
# -----------------------------------------------------------------------------
    ...
    with bc_col1:
        # --- LOOKING FOR POSTER (poster.jpg) ---
        poster_path = get_image_path("poster") # Checks for poster.jpg, poster.jpeg, etc.
        if poster_path:
...
# -----------------------------------------------------------------------------
    ...
    with col_img:
        # --- LOOKING FOR PROFILE (profile.jpg) ---
        profile_path = get_image_path("profile") # Checks for profile.jpg, profile.jpeg, etc.
        if profile_path:
            st.image(profile_path, caption="Mohammed Salmaan M", width=200)
        else:
